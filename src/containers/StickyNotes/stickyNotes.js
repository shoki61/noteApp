                ...
                <View style={styles.stickyNoteView}>
                    ...
                    <Text style={styles.date}>{value.date}-{value.time}</Text>
                    {
                        ...
                        <View style={styles.editView}>
                            <Button
                                clicked={() => this.pushEditStickyNote(index)}
                                opacity={helper.buttonOpacity}
                                styles={buttons.stickyNoteEdit}
                            >
                ...
                <View style={[styles.stickyNoteContainer,saveData.userStickyNotes.length<=0&&{justifyContent:'center'}]}>
                    {
                        ...
                        <View style={[{width:'100%',alignItems:'flex-end',paddingRight:20,paddingLeft:15,height:35},this.state.selectStickyNote&&{flexDirection:'row',justifyContent:'space-between',alignItems:'center'}]}>
                            <Button clicked={()=>this.deleteAllStickyNote()} opacity={helper.buttonOpacity} styles={buttons.deleteAllSticky}>
                    ...
                    }
                    {
                        ...
                        <Button
                            styles={[saveData.userStickyNotes.length>0?buttons.addButtonAbsolute:buttons.addButton,{backgroundColor:'#ff9d5b'}]}
                            opacity={helper.buttonOpacity}
                            clicked={()=> this.props.navigation.navigate('Add_New_Sticky_Note')}
                        >
